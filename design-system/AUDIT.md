...
| Brand manifest | Static contract | Mark family, standalone outlines, complete lockups, two raster exports | Canonical copy, path-only SVGs, and routes validated | Complete | 10/10 |
...
These are documented evolution items, not release blockers for 3.0.1. The complete brand identity has no remaining surface-level or runtime-type overrides.
